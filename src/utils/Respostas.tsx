const Respostas = [
    ...
    { id: 5, texto: 'Serviços! Temos os seguintes serviços disponíveis: "Coleta de Recicláveis", como: papelão, metais, óleo "velho", coleta de vidro, coleta de ferro, coleta de alumínio, etc.', tipo: 'response' },
    { id: 6, texto: 'Colaboradores! Nossos colaboradores são pessoas que trabalham na área de reciclagem e que dedicam seu tempo a fazer a diferença para quem mais precisa.', tipo: 'response' },
    { id: 7, texto: 'Contatos! Nossos canais de comunicação são através do E-mail: email@email.com, ou através do Telefone: (11)XXXXX-XXXX', tipo: 'response' } 
];
